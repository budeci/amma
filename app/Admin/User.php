...
})->createAndEdit(function ()
{
	...
	$form->items([
		...
		FormItem::select('seller', 'Seller')->model(Commerce\Productso\Models\PrsoSeller::class)->display('name'),
		FormItem::multiselect('theroles', 'Role')->model('App\Role')->display('name'),
